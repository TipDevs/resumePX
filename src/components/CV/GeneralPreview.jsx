export default function GeneralPreview({generalData}) {
    ...
    <div id="generalPreview">
        ...
        <p id="description" style={{fontSize: "1rem", fontWeight: "lighter", marginTop: "3px", maxWidth: "50ch", overflowWrap: "break-word", textAlign: "center" }}>{generalData.description}</p>
    </div>
    </>) 
}